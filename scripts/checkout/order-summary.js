...
cart.forEach((cartItem) => {
    ...
    // Add separate containers for each item
    cartSummaryHtml += `
...
// Function to generate delivery options
...
// Render the HTML into the order summary
...
document.querySelectorAll('.js-delete').forEach((link) => {
    link.addEventListener('click', () => {
        ...
        // Remove the container for the deleted item
